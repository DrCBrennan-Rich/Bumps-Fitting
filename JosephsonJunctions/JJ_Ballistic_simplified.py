...
def JC_model(d_F, Temperature, SC_gap, CoherenceLength, Amplitude=Amplitude):
    ...
    IcRn = Amplitude*np.abs(SincTerm) #Voltage in V
    
    return 1E-6*IcRn #Returns the voltage in uV
