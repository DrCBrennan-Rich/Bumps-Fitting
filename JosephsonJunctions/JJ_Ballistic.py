...
def JC_Ballistic(d_F, CoherenceLength, SC_gap, PhiIncriment=60):
    ...
    PhiList = np.linspace(0, 2*np.pi, int(PhiIncriment), endpoint=False)[:,None]
...
Model = bmp.Curve(JC_Ballistic, d, y, dy)
...
Model.PhiIncriment.value = PhiIncriment
